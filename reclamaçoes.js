...
function getBotResponse(message) {
    ...
    if (message.includes("o que é uma manifestação")) {
        response = "Uma manifestação é um registro feito por um cliente ou colaborador  para expressar suas opiniões, denúncias, sugestões, solicitações ou elogios sobre serviços públicos.";
        ...
        response = "O sistema não requer instalação por parte do usuário. Basta acessar a plataforma online.";
